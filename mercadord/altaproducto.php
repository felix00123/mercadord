<?php
	...
	if(!isset($_POST['producto']) &&  !isset($_POST['descripcion']) && !isset($_POST['precio'])&& !isset($_POST['precioc'])&& !isset($_POST['seccion'])){
			...
			if ((($_FILES["file"]["type"] == "image/gif")
		  	...
		  	if ($_FILES["file"]["error"] > 0){
		    	...
		    	if(file_exists("../productos/".$random.'_'.$_FILES["file"]["name"])){
					...
					$Sql="insert into productos (producto,descripcion,Imagen,precio,idvendedor,seccion,estado) values(
							'".$producto."',
							'".$descripcion."',
							'".$imagen."',
							'".$precio."',
