...
$stm = $conexion->query("SELECT  productos.precio as 'precio',
productos.titulo as 'titulo',
 fotos.ruta  ,fotos.usuario ,productos.usuario
   ...
   <div class="IMGproductos"
    style="background-image:url(Productos/<?php echo($row['ruta']);?>)"
     alt="<?php echo( $row['titulo']);  ?>">
           ...
           <img src="Productos/<?php echo($row['ruta']);?>" alt="<?php echo( $row['titulo']);  ?>">             
    </div>
