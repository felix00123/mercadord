      ...
      <?php 
        ...
        <?php
          ...
          if(isset($_SESSION['user']))
           {
        ?>
        <a class="btn btn-outline-info btnLogin btnPublicar" href="./publicarProducto.php"><i class="fas fa-plus"></i> Publicar</a>
        <div class="dropdown">
...
$secondquery = $conexion->query("SELECT * FROM `usuarios` WHERE `id_usuario` = '$_GET[user]';");
...
?>
    ...
    <div class="contenido">
      ...
      <?php } else{  ?>
        <div class="contenidoPerfilImg">
            <div class="fotoCuenta" style="background-image: url('fotos/<?php echo( $row2['fotoperfil']).'.jpg'; ?>');">
      ...
      ?>
        ...
        <div class="bodyContent">
          <div>
            <p><i class="fas fa-envelope-open-text"></i> <?php echo ($row2['mail']);  ?></p>
          </div>
          <div>
            <p><i class="fas fa-phone-square-alt"></i> <?php echo ($row2['telefono']);  ?></p>
          </div>
          <div>
            <p><i class="fas fa-map-marker-alt"></i> <?php echo ($row2['direccion']);  ?></p>
          </div>
        </div>
      </aside>
      ...
      <main class="contenidoMain">
        ...
        <section class="conenido-Productos">
          <div class="titleAnuncio">
            <h5>Productos de <?php echo $row2['nombre']  ?> </h5> 
          </div>
        <div class="container">
          <div class="row filaProductos">
              ...
              join `productos`  on fotos.producto = productos.id_pub WHERE `albumes`.`usuario` = '$_GET[user]';");
